...
import com.thoughtsbyashish.restservices.entities.Role;
import com.thoughtsbyashish.restservices.entities.User;
import com.thoughtsbyashish.restservices.repositories.UserRepository;
import com.thoughtsbyashish.restservices.services.UserService;
...
public class UserWebController {
	...
	public String addUser(ModelMap model, @Valid User user, BindingResult result) { // Updated with @Valid
		if (result.hasErrors()) {
			return "user";
		}
	...
	public String updateUser(ModelMap model, @Valid User user, BindingResult result) { // Updated with @Valid
		if (result.hasErrors()) {
			return "user";
		}
	...
	/**
	 * This method will delete a user by its ID value.
	 */
